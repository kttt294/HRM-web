...
router.post('/', requirePermission('manage_employees'), salaryController.create);

// PATCH /api/salary/:id - Cập nhật bảng lương (chỉ HR)
router.patch('/:id', requirePermission('manage_employees'), salaryController.update);

// DELETE /api/salary/:id - Xóa bảng lương (chỉ HR)
router.delete('/:id', requirePermission('manage_employees'), salaryController.delete);
