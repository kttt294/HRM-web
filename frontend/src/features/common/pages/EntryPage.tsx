    ...
    >
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
          ...
          />
          <span
            style={{ fontSize: "20px", fontWeight: "700", color: "#1a237e" }}
          >
      ...
      >
        ...
        <div
          style={{
            ...
            height: "600px",
            background:
              "radial-gradient(circle, rgba(235, 245, 255, 0.8) 0%, rgba(255,255,255,0) 70%)",
            borderRadius: "50%",
            zIndex: 0,
          }}
        />
        ...
        >
          ...
          >
            Hệ thống HRM hiện đại giúp doanh nghiệp tối ưu hóa quy trình tuyển
            dụng, quản lý hồ sơ và nâng cao trải nghiệm ứng viên.
          </p>
        </div>
      </section>
  ...
  >([
    {
      ...
      parts: [
        {
          text: "Xin chào! Tôi là trợ lý AI của hệ thống HRM. Tôi có thể giúp bạn tìm hiểu về hệ thống và các tính năng. Bạn cần hỗ trợ gì không?",
        },
      ],
    },
  ]);
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      setChatHistory((prev) => [
        ...
        {
          role: "model",
          parts: [{ text: "Xin lỗi, tôi đang gặp sự cố. Vui lòng thử lại!" }],
        },
      ]);
    } finally {
      setIsLoading(false);
              ...
              >
                ...
                <span
                  style={{
                    ...
                    background: "#ccc",
                    display: "inline-block",
                    animation: "typingJump 0.6s 0.2s infinite alternate",
                  }}
                ></span>
                <span
                  style={{
                    ...
                    background: "#ccc",
                    display: "inline-block",
                    animation: "typingJump 0.6s 0.4s infinite alternate",
                  }}
                ></span>
              </div>
            )}
