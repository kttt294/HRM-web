...
export function UserFormPage() {
    ...
    if (success) {
        return (
            <div ref={containerRef} style={{ textAlign: 'center', padding: '60px 20px' }}>
                <div style={{
                    width: '80px',
                    height: '80px',
                    margin: '0 auto 24px',
    ...
    return (
        <div ref={containerRef} style={{ maxWidth: '800px', margin: '0 auto' }}>
            {/* Header */}
            <div className="page-header form-section" style={{ opacity: 0, marginBottom: '32px', textAlign: 'center' }}>
                <h1 style={{ 
                    fontSize: '32px', 
                ...
                <div style={{
                    ...
                    <div className="form-section" style={{ opacity: 0 }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '24px' }}>
                            ...
                            <h3 style={{ fontSize: '18px', fontWeight: '600', margin: 0 }}>Thông tin cơ bản</h3>
                        </div>
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '24px' }}>
                            ...
                            <div>
                                <Input
                                    ...
                                    style={{ height: '48px', fontSize: '15px' }}
                                />
                                <p style={{ fontSize: '12px', color: '#9e9e9e', marginTop: '6px', paddingLeft: '4px' }}>
                    ...
                    {/* Password Section */}
                    <div className="form-section" style={{ marginTop: '40px', opacity: 0 }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '24px' }}>
                            <h3 style={{ fontSize: '18px', fontWeight: '600', margin: 0 }}>Bảo mật</h3>
                        </div>
                    ...
                    <div className="form-section" style={{ marginTop: '40px', opacity: 0 }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '24px' }}>
                            ...
                            <h3 style={{ fontSize: '18px', fontWeight: '600', margin: 0 }}>Phân quyền</h3>
                        </div>
                        ...
                        <div style={{ 
                            ...
                            <label style={{ display: 'block', marginBottom: '12px', fontWeight: '600', fontSize: '14px', color: '#4a5568' }}>
                                Chọn vai trò
                            </label>
                            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
                                {[
                                    { r: Role.EMPLOYEE, label: 'Nhân viên', color: '#4caf50' },
                                    { r: Role.HR, label: 'HR Manager', color: '#1976d2' },
                                    { r: Role.ADMIN, label: 'System Admin', color: '#f44336' },
                                ].map((item) => (
                                    <div
                                        key={item.r}
                                        ...
                                        style={{
                                            ...
                                            background: formData.role === item.r ? `${item.color}10` : 'white',
                                            cursor: 'pointer',
                                    ...
                                    >
                                        ...
                                        <div style={{ fontWeight: formData.role === item.r ? '600' : '500', color: formData.role === item.r ? item.color : '#4a5568' }}>
                                            {item.label}
                                        </div>
                                        {formData.role === item.r && (
                                            <div style={{ marginLeft: 'auto', color: item.color }}>✓</div>
                                        )}
                                    </div>
                                ))}
                            </div>
