        ...
        <div ref={containerRef}>
            ...
            <div style={{ display: 'flex', gap: '16px', marginBottom: '24px' }}>
                <div style={{
                    ...
                    <div style={{ fontSize: '14px', opacity: 0.9, marginBottom: '4px' }}>Tổng phòng ban</div>
                    <div style={{ fontSize: '28px', fontWeight: '700' }}>{departments.length}</div>
                </div>
            </div>
                            ...
                            {departments.map((dept) => (
                                ...
                                >
                                    <td style={{ padding: '14px 16px' }}>
                                        <div style={{ fontWeight: '500', color: '#1976d2' }}>{dept.name}</div>
                                    </td>
